    ...
    methods: {
        ...
        async uploadFile() {
            ...
            try {
                ...
                this.fetchStudents()    // Fetch students after upload
        ...
        async fetchStudents(page = 1) {
            // Update this to use the class filter
        ...
        async filterByClass() {
            ...
            this.currentPage = 1; // Reset to the first page on class change
            await this.fetchStudents(this.currentPage, this.selectedClass); // Pass the selected class
        },
    },
    mounted() {
        this.fetchStudents();
